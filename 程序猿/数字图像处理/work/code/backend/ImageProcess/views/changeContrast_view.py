...
import base64
from ImageProcess.AiModels.AiProc.changeContrast import changeContrast
import numpy as np
import cv2
...
class changeContrast_view(View):
    def post(self, request, *args, **kwargs):
        ...
        # 获取对比度
        contrast_degree = request.POST.get('contrast_degree')
        # 获取图片格式
        ...
        try:
            # 对比度结果
            img = changeContrast(img, (int)(contrast_degree))
            # 转码base64
