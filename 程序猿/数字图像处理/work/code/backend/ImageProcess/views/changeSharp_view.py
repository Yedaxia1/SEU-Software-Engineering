...
import base64
from ImageProcess.AiModels.AiProc.changeSharp import changeSharp
import numpy as np
import cv2
...
class changeSharp_view(View):
    def post(self, request, *args, **kwargs):
        ...
        # 获取锐化度
        # sharp_degree = request.POST.get('sharp_degree')
        sharp_degree = 45
        # 获取图片格式
        ...
        try:
            # 锐化结果
            img = changeSharp(img, (int)(sharp_degree))
            # 转码base64
