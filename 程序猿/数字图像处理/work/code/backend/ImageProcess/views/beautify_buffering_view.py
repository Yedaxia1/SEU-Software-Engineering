...
import base64
from ImageProcess.AiModels.AiProc.beautify import Beauty
import numpy as np
import cv2
...
class beautify_buffering_view(View):
    def post(self, request, *args, **kwargs):
        ...
        # 获取锐化度
        buffer_degree = request.POST.get('buffer_degree')
        # 获取图片格式
        ...
        try:
            # 美白结果
            img = Beauty().buffing(img, (int)(buffer_degree))
            # 转码base64
