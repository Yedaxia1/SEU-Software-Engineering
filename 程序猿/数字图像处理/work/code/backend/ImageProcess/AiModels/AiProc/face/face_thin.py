# -*- coding: utf-8 -*-
"""
Created on Sat Jul 25 00:22:59 2020
...
# predictor_path='../../backend/ImageProcess/AiModels/resource/'
...
def main():
    src = cv2.imread('C:/Users/76785/Desktop/6.jpg')
    cv2.imshow('src', src)
    face_thin_auto(src)
    cv2.waitKey(0)
