# -*- coding: utf-8 -*-
"""
Created on Thu Jul 27 09:26:14 2020
...
style_dataset = torchvision.datasets.ImageFolder('/WikiArt/', transform=data_transform)
content_dataset = torchvision.datasets.ImageFolder('/COCO/', transform=data_transform)
